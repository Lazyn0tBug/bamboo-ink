...
- [x] **Unit A1: 修复 claim bug + 合并标题扫描重叠**
...
- [x] **Unit A2: classifyByAttributes 规则表重构 + R5/R7/R8**
...
- [x] **Unit A5: 可观测性 — 结构化日志 + 异常诊断 + CLI 控制**
...
- [x] **Unit A6: processNode 重构为领地式 Pass 4-9 + 文本装配器**
